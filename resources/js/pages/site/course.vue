                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div class="pt-6">
                            ...
                            <div class="mt-4 flex items-center justify-between gap-4">
                                ...
                                <button
                                    type="button"
                                    class="inline-flex items-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 focus:outline-none dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                                >
                                    <svg
                ...
                <div class="relative h-full w-full max-w-xl md:h-auto">
                    ...
                    <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
                                ...
                                <div>
                                    ...
                                    <ul class="grid grid-cols-2 gap-4">
                                        <li>
                                            ...
                                            <label
                                                for="delivery-usa"
                                                class="inline-flex w-full cursor-pointer items-center justify-between rounded-lg border border-gray-200 bg-white p-2 text-gray-500 peer-checked:border-primary-600 peer-checked:text-primary-600 hover:bg-gray-100 hover:text-gray-600 md:p-5 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:peer-checked:text-primary-500 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                                            >
                                                <div class="block">
                        ...
                        <div class="flex items-center space-x-4 rounded-b p-4 md:p-5 dark:border-gray-600">
                            <button
                                type="submit"
                                class="rounded-lg bg-primary-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 focus:outline-none dark:bg-primary-700 dark:hover:bg-primary-800 dark:focus:ring-primary-800"
                            >
                                Show 50 results
                            </button>
                            <button
                                type="reset"
                                class="rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                            >
                                Reset
                            </button>
                        </div>
