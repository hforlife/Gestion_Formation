            ...
            <div class="mx-auto max-w-screen-xl items-center gap-8 px-4 py-8 sm:py-16 md:grid md:grid-cols-2 lg:px-6 xl:gap-16">
                ...
                <div class="mt-4 md:mt-0">
                    ...
                    <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
                        Flowbite helps you connect with friends and communities of people who share your interests. Connecting with your friends and
                        family as well as discovering new ones is easy with features like Groups.
                    </p>
                    <a
                        href="#"
        ...
        <section class="bg-gray-50 py-8 antialiased md:py-12 dark:bg-gray-900">
            <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                ...
                <div class="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
                    <div>
                        <h2 class="mt-3 text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Electronics</h2>
                    </div>
                ...
                <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
                    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div class="pt-6">
                            ...
                            <a href="#" class="text-lg leading-tight font-semibold text-gray-900 hover:underline dark:text-white"
                            ...
                            <div class="mt-4 flex items-center justify-between gap-4">
                                <p class="text-2xl leading-tight font-extrabold text-gray-900 dark:text-white">$1,699</p>

                                <button
                                    type="button"
                                    class="bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 inline-flex items-center rounded-lg px-5 py-2.5 text-sm font-medium text-white focus:ring-4 focus:outline-none"
                                >
                                    <svg
                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div class="pt-6">
                            ...
                            <div class="mt-4 flex items-center justify-between gap-4">
                                <p class="text-2xl leading-tight font-extrabold text-gray-900 dark:text-white">$1,199</p>
                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div class="pt-6">
                            ...
                            <div class="mt-4 flex items-center justify-between gap-4">
                                <p class="text-2xl leading-tight font-extrabold text-gray-900 dark:text-white">$799</p>
                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div class="pt-6">
                            ...
                            <div class="mt-4 flex items-center justify-between gap-4">
                                <p class="text-2xl leading-tight font-extrabold text-gray-900 dark:text-white">$499</p>
                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div class="pt-6">
                            ...
                            <div class="mt-4 flex items-center justify-between gap-4">
                                <p class="text-2xl leading-tight font-extrabold text-gray-900 dark:text-white">$2,599</p>
                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div class="pt-6">
                            ...
                            <div class="mt-4 flex items-center justify-between gap-4">
                                <p class="text-2xl leading-tight font-extrabold text-gray-900 dark:text-white">$699</p>
                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div class="pt-6">
                            ...
                            <div class="mt-4 flex items-center justify-between gap-4">
                                <p class="text-2xl leading-tight font-extrabold text-gray-900 dark:text-white">$899</p>
            ...
            <form
                ...
                tabindex="-1"
                aria-hidden="true"
                class="h-modal fixed top-0 right-0 left-0 z-50 hidden w-full overflow-x-hidden overflow-y-auto p-4 md:inset-0 md:h-full"
            >
                <div class="relative h-full w-full max-w-xl md:h-auto">
                    ...
                    <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
                        ...
                        <div class="px-4 md:px-5">
                                ...
                                <div class="grid grid-cols-2 gap-4 md:grid-cols-3" id="brand" role="tabpanel" aria-labelledby="brand-tab">
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="allview" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                Allview (45)
                                            </label>
                                        </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="brother" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                Brother (176)
                                            </label>
                                        </div>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="biostar" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                Biostar (49)
                                            </label>
                                        </div>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="blaupunkt" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                Blaupunkt (45)
                                            </label>
                                        </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="corsair" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                Corsair (15)
                                            </label>
                                        </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="dogfish" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                Dogfish (24)
                                            </label>
                                        </div>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="digitus" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                Digitus (1)
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="emerson" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                Emerson (45)
                                            </label>
                                        </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="fujitsu" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                Fujitsu (97)
                                            </label>
                                        </div>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="foxconn" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                Foxconn (234)
                                            </label>
                                        </div>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label for="floston" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                Floston (45)
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="space-y-4" id="advanced-filters" role="tabpanel" aria-labelledby="advanced-filters-tab">
                                <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                                    ...
                                    <div class="space-y-3">
                                        <div>
                                            <label for="min-delivery-time" class="block text-sm font-medium text-gray-900 dark:text-white">
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-2">
                                            <div class="flex items-center">
                                                ...
                                                <label for="under-1-kg" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                    Under 1 kg
                                                </label>
                                            </div>
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <label for="1-1-5-kg" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                    1-1,5 kg
                                                </label>
                                            </div>
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <label for="1-5-2-kg" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                    1,5-2 kg
                                                </label>
                                            </div>
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <label for="2-5-3-kg" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                    2,5-3 kg
                                                </label>
                                            </div>
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <label for="over-3-kg" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                    Over 3 kg
                                                </label>
                                            </div>
                                        </div>
                        ...
                        <div class="flex items-center space-x-4 rounded-b p-4 md:p-5 dark:border-gray-600">
                            <button
                                type="submit"
                                class="bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 dark:bg-primary-700 dark:hover:bg-primary-800 dark:focus:ring-primary-800 rounded-lg px-5 py-2.5 text-center text-sm font-medium text-white focus:ring-4 focus:outline-none"
                            >
                                Show 50 results
                            </button>
                            <button
                                type="reset"
                                class="hover:text-primary-700 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 focus:z-10 focus:ring-4 focus:ring-gray-200 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                            >
                                Reset
                            </button>
                        </div>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
                ...
                <div class="space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
                    <div>
                        <div class="bg-primary-100 dark:bg-primary-900 mb-4 flex h-10 w-10 items-center justify-center rounded-full lg:h-12 lg:w-12">
                            <svg
